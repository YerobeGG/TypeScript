...
// kind of boxes the printer has to use colors which, for the 
...
//     let max_length: number = s.length
//     let good_letters: string = 'abcdefghijklm'
//     let errorNums: number = 0
//     for (let value = 0; value < s.length; value++){
//       if (!good_letters.includes(s[value])){
//           errorNums += 1
//       }
//       else {
//         errorNums + 0
